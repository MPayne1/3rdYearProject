...
var selectLeagues  = async function(city, county, country, sport, callback) {
  var res;
    var sql = `SELECT leagueID, LeagueName, Sport FROM League WHERE city = ${mysql.escape(city)} and county = ${mysql.escape(county)}  and country =  ${mysql.escape(country)} and Sport =  ${mysql.escape(sport)} ;`;
