...
var insertBasketballRankings  = async function(seasonID, teamID, played,
  wins, draws, losses, PointsScored, PointsConceded, Points) {
    var sql = `INSERT INTO basketballRankings(seasonID, TeamID, played,
      wins, draws, losses, PointsScored, PointsConceded, Points)
...
module.exports = insertBasketballRankings;
