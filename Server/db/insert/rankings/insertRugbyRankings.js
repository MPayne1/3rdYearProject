...
var insertRugbyRankings  = async function(seasonID, teamID, played,
  wins, draws, losses, PointsScored, PointsConceded, Points) {
    var sql = `INSERT INTO rugbyRankings(seasonID, TeamID, played,
      wins, draws, losses, PointsScored, PointsConceded, Points)
...
module.exports = insertRugbyRankings;
