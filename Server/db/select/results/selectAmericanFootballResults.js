...
/*
  select the american football results
*/
var selectAmericanFootballResults  = async function(leagueID, callback) {
  var res;
    ...
    from (select teamName as HomeTeamName, HometeamID , fixture.fixtureID,
      ...
      team.legaueID = season.leagueID and
...
module.exports = selectAmericanFootballResults;
